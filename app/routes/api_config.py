...
from .v1_endpoint import usuario_routes, produto_routes, vendedor_routes,image_routes
...
api_router.include_router(image_routes.router, prefix='/imagens', tags=['imagens'])