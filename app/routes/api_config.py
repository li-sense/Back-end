...
from .v1_endpoint import usuario_routes, produto_routes, vendedor_routes,imagem_usuario_routes, endereco_usuario_routes
...
api_router.include_router(endereco_usuario_routes.router, prefix='/enderecos', tags=['enderecos'])